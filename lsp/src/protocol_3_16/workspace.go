...
type WorkspaceDidChangeWorkspaceFoldersFunc func(ctx *glsp.Context, params *DidChangeWorkspaceFoldersParams) error
...
type WorkspaceDidChangeConfigurationFunc func(ctx *glsp.Context, params *DidChangeConfigurationParams) error
...
type WorkspaceDidChangeWatchedFilesFunc func(ctx *glsp.Context, params *DidChangeWatchedFilesParams) error
...
type WorkspaceSymbolFunc func(ctx *glsp.Context, params *WorkspaceSymbolParams) ([]SymbolInformation, error)
...
type WorkspaceExecuteCommandFunc func(ctx *glsp.Context, params *ExecuteCommandParams) (any, error)
...
type WorkspaceWillCreateFilesFunc func(ctx *glsp.Context, params *CreateFilesParams) (*WorkspaceEdit, error)
...
type WorkspaceDidCreateFilesFunc func(ctx *glsp.Context, params *CreateFilesParams) error
...
type WorkspaceWillRenameFilesFunc func(ctx *glsp.Context, params *RenameFilesParams) (*WorkspaceEdit, error)
...
type WorkspaceDidRenameFilesFunc func(ctx *glsp.Context, params *RenameFilesParams) error
...
type WorkspaceWillDeleteFilesFunc func(ctx *glsp.Context, params *DeleteFilesParams) (*WorkspaceEdit, error)
...
type WorkspaceDidDeleteFilesFunc func(ctx *glsp.Context, params *DeleteFilesParams) error

// https://microsoft.github.io/language-server-protocol/specifications/specification-3-16/#textDocument_semanticTokens
const MethodWorkspaceSemanticTokensRefresh = Method("workspace/semanticTokens/refresh")

type WorkspaceSemanticTokensRefreshFunc func(ctx *glsp.Context) error
